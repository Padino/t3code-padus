...
import { deriveLatestProviderRateLimitsSnapshot } from "../lib/providerRateLimits";
import {
...
import { RateLimitsMeter } from "./chat/RateLimitsMeter";
...
export default function ChatView({ threadId }: ChatViewProps) {
  ...
  const activeProviderRateLimits = useMemo(
    () => deriveLatestProviderRateLimitsSnapshot(activeThread?.activities ?? []),
    [activeThread?.activities],
  );
  useEffect(() => {
                    ...
                    >
                      ...
                      >
                        ...
                        {activeProviderRateLimits ? (
                          <RateLimitsMeter usage={activeProviderRateLimits} />
                        ) : null}
                        {isPreparingWorktree ? (
